...
FileNamesInfo=[
               ...
               ["_MET_OS","MET  (GeV)","",10],
               ["_M_taujet_OS","M_{#tauj}   (GeV)","",10],
               ["_LeadJetPt_OS","Leading Jet PT  (GeV)","",10],
               ["_SubLeadJetPt_OS","subLeading Jet PT  (GeV)","",10],
...
for ch in channelDirectory:
    for cat in Category:
        for i in range(0,len(FileNamesInfo)):
            ...
            MakePlot(FileName,ch+cat,FileNamesInfo[i][0],FileNamesInfo[i][1],FileNamesInfo[i][2],FileNamesInfo[i][3],ch)

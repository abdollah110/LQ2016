...
#    HistoDeNum.Scale(1000/HistoDeNum.Integral())
    ...
    theFit=TF1("theFit",_FIT_FAKE,50,400,4)
    
    
    
    theFit.SetParLimits(0,    0,     0.05);
    #theFit.SetParLimits(8,     0,  1.0);
    #theFit.SetParLimits(9,     0,  10.0);
    #theFit.SetParLimits(10,     0,  1.0);



    theFit.SetParameter(0, 0.03)
    theFit.SetParameter(1, 15)
    theFit.SetParameter(2, 1)
    theFit.SetParameter(3, 9.6)

...
#    myOut = TFile("TotalRootForLimit_"+channel + NormMC+".root" , 'RECREATE') # Name Of the output file
    myOut = TFile("WEstimation"+NormMC+".root" , 'RECREATE') # Name Of the output file
...
#            QCDEstimation= (DataSampleQCDNormHist.Integral()- (TT_qcd+ZTT_qcd+W_qcd+SingleT_qcd+VV_qcd)) * OS_SS_Ratio
            ...
            tDirectory.WriteObject(RebinedHist,'data_obs')
            ...
            Name="WJetsToLNu"
            NameOut= "W120"+str(TauScaleOut[tscale])
...
#    PlotName= ["_tmass","_VisMass","_LepPt","_LepEta","_TauPt","_TauEta","_NumJet","_NumBJet","_MET","_LeadJetPt","_SubLeadJetPt","_ST_DiJet","_ST_MET"]
    PlotName= ["_tmass","_LepPt","_LepEta","_TauPt","_TauEta","_MET","_ST_MET"]
#    PlotName= ["_MET"]
...
#Make_W_Control_Plots("_tmass_HighMT_OS","_tmass_HighMT_OS_TauIsoLepAntiIso")
    ...
    for NormMC in PlotName:
        ...
        MakeTheHistogram("MuTau",NormMC+"_HighMT_OS","_CloseJetTauPt_HighMT_OS_LepIso",NormMC+"_HighMT_OS_Total","",0,Binning)
